      ...
      <q-card>
        ...
        <q-card-section class="row col-12">
          <q-item class="row col-12">
            <q-item-section>
              <q-item-label
                >Ingresa Correo para reestablecer contraseña</q-item-label
              >
              <q-input
                class="q-ma-sm"
                label="Correo"
      ...
      auth
        ...
        .catch((error) => {
          ...
          this.$q
            .dialog({
              title: "Alerta",
              message: "Algo salió mal, revisa tu correo y contraseña",
            })
            .onOk(() => {
              // console.log('OK')
            })
